...
public class FlightController {
    ...
    public ResponseEntity<FlightResponseDto> updateFlight(@PathVariable("id") UUID id, @Valid @RequestBody FlightRequestDto flightRequestDto) {
    ...
    @GetMapping
    @Operation(summary = "Get all flights with filters.")
